...
| 63     | Data       | RIP          | [Destination]                | Load `Instruction Pointer` special register to destination register                |
| 64     | Interrupt  | SETISR       | [InteruptNumber] [Address]   | Set ISR absolute address for an interrupt                                          |
| 65     | Interrupt  | INT          | [InteruptNumber]             | Call to interrupt.                                                                 |
| 66     | Other      | NOP          |                              | No operation                                                                       |
